      ...
      <section className="bg-hack relative">
        ...
        <div className="w-11/12 mx-auto h-screen md:h-[500vh] relative">
          <div className="h-full mt-8">
            <h1 className="font-bold font-open text-white text-7xl tracking-tighter">
              Malhaar <br /> Hackerama
            </h1>
            <span className="text-red-600 font-open font-medium text-xl align-middle">
              learn | teach | explore
            </span>
            <p className="font-open text-base text-gray-600 bg-resd-400 w-1/3 py-6">
            ...
            <button className="z-40 font-open text-white font-semibold bg-red-600 hover:bg-red-800 px-6 py-2 rounded-md">
              Register
            </button>
            ...
            <div className="mt-3 flex justify-around items-center">
              <span>
                <img src={college} alt="" height={235} width={235} />
              </span>
              <span className="">
                <h4 className="text-red-600 font-medium font-open">When?</h4>
                <h2 className="text-white font-semibold font-open w-20">
                  23rd-24th November 2022
                </h2>
              </span>
              <span>
                <h4 className="text-red-600 font-medium font-open">Where?</h4>
                <h2 className="text-white font-semibold font-open w-40">
            ...
            {/* Sponsor Section */}
            <div
              className="mt-10 w-full grid grid-cols-4 gap-10 p-20"
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: "#2c343f" }}
              >
                <img src={Hack2Skill} alt="cvent-logo" />
              </div>
              <div
                className="border-r-4 flex items-center justify-center"
                style={{ borderColor: "#2c343f" }}
              >
                <img src={JohnJacobs} alt="cvent-logo" />
              </div>
              <div
                className="border-r-4 flex items-center justify-center"
                style={{ borderColor: "#2c343f" }}
              >
                <img src={Samsung} alt="cvent-logo" />
              </div>
            ...
            {/* Prize Section */}
            <h4 className="text-white text-center font-open mt-14 font-medium text-xl">
              Details
            </h4>

            <div className="flex justify-between font-open tracking-tighter mt-12">
              <div className="flex-1">
                <h1 className="text-white font-bold text-8xl">1 Lakh</h1>
                <h3 className="text-red-600 font-medium text-3xl">
                  Worth of Cash Prizes
                </h3>
              </div>
              <div className="font-open w-1/3">
                ...
                <p className="text-base text-white opacity-70">
                  ...
                  consectetur adipiscing elit. Duis augue justo, porttitor vitae
                  felis nec, molestie sodales mi. Suspendisse eget aliquam ex,
                  mollis lacinia nunc.JAKFNMDSKNLorem ipsum dolor sit amet,
                  consectetur adipiscing elit. Duis augue justo,{" "}
                </p>
              </div>
            </div>
            ...
            {/* More Gyaan Section */}
            <div
              className="w-full flex justify-between font-open mt-16 px-6 py-14 rounded-xl"
              style={{ background: "#21262f" }}
            >
              <div className="w-1/2">
                ...
                <h4 className="text-red-600 font-medium text-base">Einstein</h4>
              ...
              <div className="w-1/2 bg-yellsow-500">
                ...
                <div className="w-3/4 mx-auto flex justify-between bg-blue-400s mt-5">
                  <div>
                    <span className="relative">
                      <p className="font-bold text-gray-500 text-6xl">01</p>
                      <p className="text-white font-bold absolute -bottom-1 left-10 text-2xl">
                        Idea
                      </p>
                    </span>
                  ...
                  <div>
                    <span className="relative">
                      <p className="font-bold text-gray-500 text-6xl">02</p>
                      <p className="text-white font-bold absolute -bottom-1 left-10 text-2xl">
                        Project
                      </p>
                    </span>
                ...
                <p className="text-red-600 w-3/4 mx-auto mt-4 font-medium">
            ...
            {/* icon grid */}
            <div className="flex flex-wrap gap-20 bg-yellow-3s00 mt-28 w-3/4 mx-auto px-14">
              {data.map((item) => (
                <span
                  key={item.id}
                  className="flex flex-col items-center w-32 text-center gap-2"
                >
                  <img src={item.image} alt="team-icon" className="h-20 w-20" />
                  <p className="text-white font-semibold font-open text-sm">
                    {item.subTitle}
                  </p>
                </span>
              ))}
            ...
            {/* Mentors section */}
            <h4 className="text-white text-center font-open mt-28 font-bold text-xl">
              Mentors and Judges
            </h4>

            <div className="grid grid-cols-2 gap-4 w-3/4 ml-auto">
              {mentors.map((item) => (
            ...
            {/* Hackerama Sign */}
            <div className="bg-red-600 text-white font-open font-semibold px-4 py-2 rounded-md mt-[82px] ml-[640px] w-max">
              Hackerama Awaits You!
            </div>

            {/* Gyaan */}
            <div
              className="w-full flex flex-col gap-6 p-10 rounded-lg mt-10 items-center justify-center"
              style={{ background: "#21262f" }}
            >
          ...
          <svg
            width="1629"
            height="4443"
            className="bg-yelslow-500 w-5/6 h-full absolute top-0 md:-top-80 right-0 mt-20"
